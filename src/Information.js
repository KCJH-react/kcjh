  ...
  return <div>
    <Flex direction="column" align="center" justify="center" p="8">
      ...
      <Box as="nav" w={'100%'} p={6} color='black' borderBottomWidth='2px' borderColor='black' whiteSpace='nowrap'>
        ...
        {/*시작 날짜_StartDate*/}
      <Box role="button" cursor="pointer" bg='gray.100' display="flex" width="400px" flexDirection="row" alignItems="center" borderTopRadius="40px" ml="5" mt="3" p={4}>
            <Text fontSize="xl" flex="1">챌린지를 시작한 날짜</Text>
            <Text id="StartDate" textAlign="right">2024-03-25</Text>
        </Box>

        {/*이메일_Email -> 클릭시 이메일 수정가능*/}
        <Box role="button" cursor="pointer" bg='gray.100' display="flex" width="400px" flexDirection="row" alignItems="center" ml="5" mt="1" p={4}>
        ...
        <Box role="button" cursor="pointer" bg='gray.100' display="flex" width="400px" flexDirection="row" alignItems="center" justifyContent="center" borderBottomRadius="40px" ml="5" mt="1" mb="10" p={4}>
        ...
        {/*챌린지 비율_Challrate*/}
        <Box role="button" cursor="pointer" bg='gray.100' display="flex" width="400px" flexDirection="row" alignItems="center" borderBottomRadius="40px" ml="5" mt="1" p={4}>
