            ...
            <PopoverContent color='white' bg='blue.800' borderColor='blue.800'>
              ...
              <PopoverBody>
                <Flex direction="column">                  
                  <Button colorScheme='green' onClick={()=>{let newContent = [...contents].sort((a,b)=> a.date-b.date); 
                    setContents([...newContent]);}}>
                        최신순</Button>
                  <Button colorScheme='blue' onClick={()=>{let newContent = [...contents].sort((a,b)=> b.like-a.like); 
                    setContents([...newContent]);}}>
                        인기순
                  </Button></Flex>
              </PopoverBody>
