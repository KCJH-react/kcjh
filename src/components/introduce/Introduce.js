        ...
        <FeaturesSection>
          <FeatureGrid>
            <Feature
              ...
              description={
                "우리의 웹 서비스는 매일 새로운 도전 과제를 제공합니다. 사용자가 동기를 얻고 일상의 목표를 성취함으로써 더 보람찬 하루를 보낼 수 있도록 돕는 플랫폼입니다. 이 서비스는도전을 통해 긍정적인 변화를 추구하고 성취감을 느낄 수 있도록 설계되었습니다."
              }
            />
          </FeatureGrid>
          <FeatureGrid>
